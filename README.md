...
Built with Python + tkinter. Uses [gallery-dl](https://codeberg.org/mikf/gallery-dl) for downloading and [img2pdf](https://gitlab.mister-muffin.de/josch/img2pdf) for conversion.
...
Run `build.bat`. It bundles everything including gallery-dl and produces `dist\Library Expander.exe`. No Python or installs required to run the exe.
...
Anything supported by gallery-dl. See the full list at [codeberg.org/mikf/gallery-dl](https://codeberg.org/mikf/gallery-dl/src/branch/master/docs/supportedsites.md).
